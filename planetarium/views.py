...
class AstronomyShowViewSet(
    ...
    def get_queryset(self):
        """Retrieve the AstronomyShows with filters"""
    ...
    def upload_image(self, request, pk=None):
        """Endpoint for uploading image to specific AstronomyShow"""
    ...
    @extend_schema(
        parameters=[
            OpenApiParameter(
                ...
                description="Filter by ShowTheme id (ex. ?themes=2,3)",
            ),
            OpenApiParameter(
                "title",
                type=OpenApiTypes.STR,
                description="Filter by AstronomyShow title (ex. ?title=mars)",
            ),
        ]
    )
    ...
    @extend_schema(
        parameters=[
            OpenApiParameter(
                ...
                description=(
                    "Filter by AstronomyShow id (ex. ?astronomy_show=2)"
                ),
            ),
            OpenApiParameter(
                "date",
